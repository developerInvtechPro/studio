...
export default function OrderSummary({ orderItems, onUpdateQuantity, onRemoveItem }: OrderSummaryProps) {
  ...
  return (
    <Card className="flex-grow flex flex-col h-full">
      <CardHeader className="py-4">
        <CardTitle className="font-headline text-lg">Consumos</CardTitle>
      </CardHeader>
      ...
      {orderItems.length > 0 && (
        <CardFooter className="flex-col !p-4 border-t mt-auto gap-2 bg-muted/30">
          ...
          <Button size="lg" className="w-full font-bold text-lg h-14 mt-2">
            COBRAR
          </Button>
        </CardFooter>
      )}
